    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                ...
                if (count($cats) == 0) {
                    echo "<h3 class='no_results btn btn-default'>we not have products like that  "
                    . "<span><hr>" . $like . "</span>" .
                    "</h3>";
                }
                ?>
        ...
        <ul class="pagination">
            ...
            if ($prev == 1)
                ...
                $prev = $prev - 1;
            echo "<li ><a href='index.php?page=offers.php&searno={$prev}'>«</a></li>";
            for ($i = 1; $i <= $noOfpages; $i++)
                echo " <li><a href='index.php?page=offers.php&searno={$i}'>$i</a></li>";
            ...
            if ($next == $noOfpages)
                ...
                $next = $next + 1;
            echo "<li ><a href='index.php?page=offers.php&&&searno={$next}'>»</a></li>";
            ?>
